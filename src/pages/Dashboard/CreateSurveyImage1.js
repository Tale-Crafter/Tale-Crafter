        ...
        <div className="App">
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF', marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', filter: showConfirmation || showConfirmation1 ? 'blur(5px)' : 'none' }}>
                    ...
                    <div style={{position:"relative",top:-80}}>
                        <div style={{width: 1200, height: 830, left: 40, top: 249, position: 'absolute', background: '#F5F5F5', borderRadius: 10}} />
                        ...
                        <div style={{ width: 260, height: 51, left: 70, top: 945, position: 'absolute', zIndex:9999 }}>
                            <div style={{ width: 350, height: 51, left: 0, top: 5, position: 'absolute', background: 'lightgray', borderRadius: 10, border: '1px #CCCCCC solid' }}>
                                <div style={{left: 0, top: -30, position: 'absolute', color: 'black', fontSize: 14, fontFamily: 'revert', fontWeight: '600', wordWrap: 'break-word'}}>Validation response</div>
                            ...
                            <div style={{width: 350, height: 96, left: 380, top: -20, position: 'absolute'}}>
                                <div style={{left: 0, top: -2, position: 'absolute', color: 'black', fontSize: 14, fontFamily: 'revert', fontWeight: '600', wordWrap: 'break-word'}}>Number of responses</div>
                                <input style={{width: 350, height: 51, left: 0, top: 25, position: 'absolute', background: 'rgba(17, 17, 17, 0.10)', borderRadius: 10,border:"none"}} />
                            ...
                            <div style={{width: 350, height: 96, left: 765, top: -20, position: 'absolute'}}>
                                <div style={{left: 0, top: -2, position: 'absolute', color: 'black', fontSize: 14, fontFamily: 'revert', fontWeight: '600', wordWrap: 'break-word'}}>Custom error text</div>
                                <input style={{width: 350, height: 51, left: 0, top: 25, position: 'absolute', background: 'rgba(17, 17, 17, 0.10)', borderRadius: 10,border:"none"}} />
                                <div style={{left: 16, top: 41, position: 'absolute', color: 'rgba(0, 0, 0, 0.40)', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>Enter you question</div>
                            </div>
                        </div>
                        ...
                        <div style={{left: 1004, top: 781, position: 'absolute', color: '#111111', fontSize: 14, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word'}}>Radio box</div>
                        ...
                        <div style={{width: 1152, height: 0, left: 64, top: 910, position: 'absolute', border: '1px #DDDDDD solid'}}></div>
                        <div style={{width: 1152, height: 0, left: 64, top: 1020, position: 'absolute', border: '1px #DDDDDD solid'}}></div>

                        <div style={{padding: 8, left: 963, top: 1016, position: 'absolute', justifyContent: 'flex-start', alignItems: 'center', gap: 16, display: 'inline-flex'}}>
                        ...
                        <div style={{width: 204, padding: 16, left: 40, top: 1090, position: 'absolute', background: 'linear-gradient(90deg, #00BDA9 0%, #00C0FC 100%)', borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
...
export default CreateSurveyImage1;
