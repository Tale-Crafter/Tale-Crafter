        ...
        <div>
            ...
            {sidebarVisible ? (
                <div style={{ left: 24, top: 88, position: 'absolute', borderRadius: 10, flexDirection: 'column', justifyContent: 'flex-start', alignItems: 'flex-start', gap: 20, display: 'inline-flex' }}>
                    ...
                    <Link to={`/GestionDesUtilisateurs/${iduser}`}>
                    ...
                    <Link to={`/GestionDesSanctions/${iduser}`}>
                    ...
                    <Link to={`/ReclamationsDesClients/${iduser}`}>
                    ...
                    <Link to={`/ApprobationDesContenus/${iduser}`}>
                    ...
                    <Link to={`/GestionDesRolesEtPermissions/${iduser}`}>
                    ...
                    <Link to={`/AnalyseEtReporting/${iduser}`}>
                    ...
                    <Link to={`/CentreDeSupport/${iduser}`}>
