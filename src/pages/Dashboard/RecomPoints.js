...
import HistoryComponent from './../Points/HistoryComponent'; // Import the HistoryComponent
import arrow_forward from "../../images/Arrow.png";
import arrow_backward from "../../images/Arrow2.png";
import RechargeComponent from "./../Points/RechargeComponent";
...
const RecomPoints = () => {
    ...
    return (
        <div className="App" style={{    position: "relative",   left: -360,  top: -60 }}>
                <div style={divStyle}>

                </div>
                <div style={exploreTextStyle}>
                    Votre solde est : <div style={textStyle}>630 Points</div>
                </div>
                <div style={{ width: 1400, height: 1200, left: 340, top: 272, background: 'white',position: 'absolute', borderRadius: 16 }} >
