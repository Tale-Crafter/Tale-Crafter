...
const ConfirmationPopup = ({ onClose, onValidate }) => {
    ...
    return (
        <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', background: 'rgba(255, 255, 255, 0.9)', padding: 20, borderRadius: 8, boxShadow: '0 0 10px rgba(0, 0, 0, 0.3)', zIndex: 999 }}>
            <h2>Compte banni</h2>
            <p style={{ color: 'black', fontSize: 14, fontFamily: 'revert', fontWeight: '400', lineHeight: 1, wordWrap: 'break-word',textAlign:"left" }}>
                Compte est banni définitivement, car il a enfreint la politique relative à la propriété intellectuelle de Tale.
                <br></br>
                Raison : Maecenas rhoncus massa vel luctus posuere.
            </p>
            {/*<label>*/}
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: 20 }}>
                <div style={{ width: '48%', padding: 16, background: 'linear-gradient(90deg, #00BDA9 0%, #00C0FC 100%)', borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex', cursor: 'pointer' }} onClick={handleValidate}>
                    <div style={{ color: 'white', fontSize: 14, fontFamily: 'Open Sans', fontWeight: '600', wordWrap: 'break-word' }}>Activer</div>
                </div>
