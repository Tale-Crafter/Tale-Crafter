        ...
        <div className="App">
            <div style={{width: '100%', height: '100%', position: 'relative',left:0, background: 'none', marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', filter: showConfirmation || showConfirmation1 ? 'blur(5px)' : 'none' }}>
                ...
                <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF'}}>
                    <button style={{background:"none",border:"none",position:"absolute",left:40,marginTop:30,color: '#00BDA9', fontSize: 24, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>Preview</button>
                    <button style={{position: 'absolute',right:40,marginTop:30, height: '100%', paddingLeft: 16, paddingRight: 16, paddingTop: 20, paddingBottom: 20, background: 'rgba(0, 0, 0, 0.06)', borderRadius: 8, justifyContent: 'flex-start', alignItems: 'center', gap: 14, display: 'inline-flex'}}>
                        <div style={{width: 16, height: 16, position: 'relative'}}>
                            <img src={process.env.PUBLIC_URL + '/x.png'} style={{width: 20, height: 20, left: 0, top: 0, position: 'absolute'}}></img>
                        </div>
                        <div style={{color: '#111111', fontSize: 24, fontFamily: 'revert', fontWeight: '400', lineHeight: 30, wordWrap: 'break-word'}}>Close</div>
                    </button>
                    <div style={{width: 1850, height: 388, left: 24, top: 94, position: 'absolute', background: 'white', borderRadius: 16}} />
                    <div style={{ width: "100%", left: -50, top: 0, position: 'absolute', color: '#111111', fontSize: 24, fontFamily: 'revert', fontWeight: '700', lineHeight: 1, wordWrap: 'break-word' }}><Verylikely/></div>
                </div>
                <div style={{ position: 'relative', background: 'none',top:400}}>
