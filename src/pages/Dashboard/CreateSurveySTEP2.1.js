                    ...
                    <div style={{position:"relative",top:-80}}>
                        ...
                        <div style={{width: 400, height: 32, left: -40, top: 615, position: 'absolute'}}>
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block' }}>
                                ...
                                <span style={{ marginLeft: 5,left:0,top:-100,position:"absolute", color: selectedLanguage === 'Best' ? '#00BDA9' : 'black' }}>Option 1</span>
                        ...
                        <div style={{width: 204, padding: 16, left: 40, top: 688, position: 'absolute', background: 'linear-gradient(90deg, #00BDA9 0%, #00C0FC 100%)', borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                        ...
                        <div style={{width: 375, height: 0, left: 104, top: 554, position: 'absolute', border: '2px #CCCCCC solid'}}></div>
...
export default CreateSurveySTEP21;