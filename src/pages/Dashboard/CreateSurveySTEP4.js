    ...
    return (
        <div className="App">
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF', marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', filter: showConfirmation || showConfirmation1 ? 'blur(5px)' : 'none' }}>
                <BHeader/>
                <div style={{width: 1400, height: 1650, left: 340, top: 80, position: 'absolute', background: 'white', borderRadius: 16}} >
      ...
      Strongly disagree
                        ...
                        <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block',top:65 }}>
                                ...
                                <span style={{ marginLeft: 5,left:0,top:-100,position:"absolute", color: selectedLanguage === 'op3' ? '#00BDA9' : 'black' }}>Somewhat disagree</span>
                            ...
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block',top:100 }}>
