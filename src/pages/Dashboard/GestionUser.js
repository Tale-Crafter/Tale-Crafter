        ...
        <div className="App">
            ...
            <div style={{marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', zIndex: -1}}>
                ...
                <div style={{
                    ...
                    <div style={{left: 30, top: 20, position: 'absolute', color: 'Black', fontSize: 24, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word', whiteSpace: 'nowrap'}}>Gestion des utilisateurs</div>
                    ...
                    <div style={{
                        ...
                        {activeButton === 'Panélistes' && <TableAdminGU />}
