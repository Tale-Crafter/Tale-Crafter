    ...
    return (
        <div className="App" >
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF',marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease'}}>
                ...
                <div style={{width: 450, height: 255, left: 340, top: 312, position: 'absolute', background: 'white', borderRadius: 16}} />
                ...
                <div style={{width: 10, height: 10, left: 353, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 353, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 353, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{left: 370, top: 365, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Tech Gadgets Feedback VG1</div>
                <div style={{left: 370, top: 420, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Tech Gadgets Feedback VG2 </div>
                <div style={{left: 370, top: 480, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Tech Gadgets Feedback VG1 </div>

                <div style={{left: 370, top: 390, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Number of Questions:</div>
                <div style={{left: 370, top: 450, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Number of Questions:</div>
                <div style={{left: 370, top: 510, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Number of Questions:</div>

                <div style={{left: 490, top: 390, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>15</div>
                <div style={{left: 490, top: 450, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>10</div>
                <div style={{left: 490, top: 510, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>19</div>

                <div style={{left: 670, top: 390, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 17/10/2024</div>
                <div style={{left: 670, top: 450, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 02/08/2024</div>
                <div style={{left: 670, top: 510, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 02/04/2024</div>

                <hr style={{ left: 360, width: 400, borderTop: '0.2px solid #ccc', top: 405, position: 'absolute' }} />
                <hr style={{ left: 360, width: 400, borderTop: '0.2px solid #ccc', top: 465, position: 'absolute' }} />


                <div style={{width: 45, height: 16, left: 730, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/pg.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 35, height: 16, left: 740, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/soon.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 45, height: 16, left: 730, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/comp.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                ...
                <div style={{paddingLeft: 8, paddingRight: 8, paddingTop: 4, paddingBottom: 4, left: 440, top: 333, position: 'absolute', background: '#666666', borderRadius: 30, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                    <div style={{textAlign: 'center', color: 'white', fontSize: 10, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word'}}>3</div>
                </div>
                ...
                <div style={{width: 450, height: 255, left: 815, top: 312, position: 'absolute', background: 'white', borderRadius: 16}} />
                ...
                <div style={{width: 10, height: 10, left: 828, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 828, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 828, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{display: 'flex',left: 845, top: 365, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Integer id diam sed nunc congue s..</div>
                <div style={{display: 'flex',left: 845, top: 420, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Pellentesque iaculis ligula at qu..</div>
                <div style={{display: 'flex',left: 845, top: 480, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Mauris sed libero mollis, consec..</div>

                <div style={{display: 'flex',left: 850, top: 388, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 17/10/2024</div>
                <div style={{display: 'flex',left: 850, top: 448, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 17/10/2024</div>
                <div style={{display: 'flex',left: 850, top: 508, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 17/10/2024</div>


                <div style={{width: 32, height: 16, left: 1217, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/live.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 35, height: 16, left: 1215, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/soon.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 45, height: 16, left: 1205, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/comp.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>


                <hr style={{ left: 835, width: 400, borderTop: '0.2px solid #ccc', top: 405, position: 'absolute' }} />
                <hr style={{ left: 835, width: 400, borderTop: '0.2px solid #ccc', top: 465, position: 'absolute' }} />


                <div style={{width: 90, height: 30, left: 840, top: 530, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/interv.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 7, height: 7, left: 1030, top: 534, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/gr8.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 7, height: 7, left: 1041, top: 534, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/grf.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                ...
                <div style={{width: 450, height: 255, left: 1290, top: 312, position: 'absolute', background: 'white', borderRadius: 16}} />
                ...
                <div style={{width: 10, height: 10, left: 1303, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 1303, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>
                <div style={{width: 10, height: 10, left: 1303, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/Fo.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{left: 1320, top: 365, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Etiam vel sapien vitae risus tincidun..</div>
                <div style={{left: 1320, top: 420, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Nulla imperdiet tortor a interdum sc..</div>
                <div style={{left: 1320, top: 480, position: 'absolute', color: 'Black', fontSize: 18, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word',textAlign: 'left'}}>Duis dignissim purus eu ex dapibus ..</div>

                <div style={{left: 1320, top: 388, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '500', wordWrap: 'break-word',textAlign: 'left'}}>Survey</div>
                <div style={{left: 1320, top: 448, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '500', wordWrap: 'break-word',textAlign: 'left'}}>Survey</div>
                <div style={{left: 1320, top: 508, position: 'absolute', color: 'black', fontSize: 12, fontFamily: 'revert', fontWeight: '500', wordWrap: 'break-word',textAlign: 'left'}}>Focusgroup</div>

                <div style={{left: 1450, top: 390, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 17/10/2024</div>
                <div style={{left: 1450, top: 450, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 02/08/2024</div>
                <div style={{left: 1450, top: 510, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Launch: 02/04/2024</div>

                <div style={{left: 1620, top: 390, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Deliver: 17/10/2024</div>
                <div style={{left: 1620, top: 450, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Deliver: 17/10/2024</div>
                <div style={{left: 1620, top: 510, position: 'absolute', color: 'grey', fontSize: 12, fontFamily: 'revert', fontWeight: '400', wordWrap: 'break-word',textAlign: 'left'}}>Deliver: 17/10/2024</div>

                <div style={{width: 25, height: 25, left: 1690, top: 365, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/telch.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 25, height: 25, left: 1690, top: 420, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/telch.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <div style={{width: 25, height: 25, left: 1690, top: 480, position: 'absolute'}}>
                    <img src={process.env.PUBLIC_URL + '/telch.png'} alt="" style={{ width: '100%', height: '100%' }} />
                </div>

                <hr style={{ left: 1310, width: 400, borderTop: '0.2px solid #ccc', top: 405, position: 'absolute' }} />
                ...
                <div style={{paddingLeft: 8, paddingRight: 8, paddingTop: 4, paddingBottom: 4, left: 1390, top: 333, position: 'absolute', background: '#666666', borderRadius: 30, flexDirection: 'column', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
                ...
                <div style={{left: 1310, top: 677, position: 'absolute', color: 'Black', fontSize: 22, fontFamily: 'revert', fontWeight: '700', wordWrap: 'break-word', whiteSpace: 'nowrap'}}>Distribution of Participants</div>
...
export default Businesshomedata;
