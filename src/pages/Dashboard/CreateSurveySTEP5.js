    ...
    return (
        <div className="App">
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF', marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', filter: showConfirmation || showConfirmation1 ? 'blur(5px)' : 'none' }}>
                <BHeader/>
                <div style={{width: 1400, height: 1130, left: 340, top: 80, position: 'absolute', background: 'white', borderRadius: 16}} >
                    ...
                    <div style={{width: 1152, height: 0, left: 64, top: 1040, position: 'absolute', border: '1px #DDDDDD solid'}}></div>

                    <div style={{position:"relative",top:0,left:50}}>
                        <CreateSurveyImage></CreateSurveyImage>
                    </div>
                    <button style={{border:"2px solid black",backgroundColor:"transparent",position:"absolute",top:1050,left:40,width: 147, height: 51, padding: 16, borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
                        <div style={{color: 'black', fontSize: 14, fontFamily: 'revert', fontWeight: '600', wordWrap: 'break-word'}}>Previous</div>
                    </button>
                    <button style={{border:"none",position:"absolute",top:1050,right:150,width: 147, height: 51, padding: 16, background: '#DDDDDD', borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}>
...
export default CreateSurveySTEP5;
