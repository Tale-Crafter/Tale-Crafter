        ...
        <div className="App">
            ...
            <div style={{width: '100%', height: '100%', position: 'relative', background: '#EFEFEF', marginLeft: !sidebarVisible ? -100 : 0, transition: 'margin-left 0.3s ease', filter: showConfirmation ? 'blur(5px)' : 'none' }}>
                ...
                <div style={{width: 1400, height: 736, left: 340, top: 80, position: 'absolute', background: 'white', borderRadius: 16}} >
                    ...
                    <div style={{ marginTop: 20 }}>
                        ...
                        <div>
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block' }}>
                                ...
                                <span style={{ marginLeft: 5,left:40,top:-100,position:"absolute", color: selectedLanguage === 'Yes' ? '#00BDA9' : 'black' }}>Raisons de santé</span>
                            ...
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block' }}>
                                ...
                                <span style={{ marginLeft: 5,left:40,top:-50,position:"absolute", color: selectedLanguage === 'No' ? '#00BDA9' : 'black' }}>Rejet de l'odeur et de la fumée</span>
                            ...
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block' }}>
                                ...
                                <span style={{ marginLeft: 5,left:40,top:0,position:"absolute", color: selectedLanguage === 'Y' ? '#00BDA9' : 'black' }}>Principe moral</span>
                            ...
                            <label style={{ margin: '0 150px', position: 'relative', cursor: 'pointer', display: 'block' }}>
                                ...
                                <span style={{ marginLeft: 5,left:40,top:50,position:"absolute", color: selectedLanguage === 'N' ? '#00BDA9' : 'black' }}>Autre</span>
                    ...
                    <Button style={{border: '2px solid #00BDA9',position:"relative",left:-520,top:220,width: '11.5%', height: '6.5%', padding: 16, background: 'white', borderRadius: 10, justifyContent: 'center', alignItems: 'center', display: 'inline-flex'}}   onClick={() => { window.location.href = `/tobacco8/${iduser}`; }}
                    >
