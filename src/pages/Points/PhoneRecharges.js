...
const PhoneRecharge  = () => {
 ...
 // Function to handle clicks on operator boxes
const handleOperatorBoxClick = (event) => {
    // Get all operator box elements
    const allOperatorBoxes = document.querySelectorAll('.operator-box');
    
    // Reset the border color of all operator boxes to default (black)
    allOperatorBoxes.forEach(box => {
        box.style.borderColor = 'black';
    });
    
    // Get the clicked operator box element
    const clickedOperatorBox = event.currentTarget;
    
    // If the clicked box is already selected, remove the selection
    if (clickedOperatorBox.style.borderColor === 'blue') {
        clickedOperatorBox.style.borderColor = 'black';
    } else {
        // Otherwise, change the border color of the clicked operator box to blue
        clickedOperatorBox.style.borderColor = 'blue';
    }
};

// Function to handle clicks on amount boxes
const handleAmountBoxClick = (event) => {
    ...
    // Get the clicked amount box element
    const clickedAmountBox = event.currentTarget;
    
    // If the clicked box is already selected, remove the selection
    if (clickedAmountBox.style.borderColor === 'blue') {
        clickedAmountBox.style.borderColor = 'black';
    } else {
        clickedAmountBox.style.borderColor = 'blue';
    }
};

// Function to handle double clicks on boxes to remove selection
const handleBoxDoubleClick = (event) => {
...
<div style={{marginLeft:"10px",marginTop:'100px',whiteSpace: 'nowrap', fontFamily: 'Revert', fontSize: '22px', fontWeight: 1700, lineHeight: '19px', letterSpacing: 0, textAlign: 'left', width: '150px', height: '49px' }}>
    ...
    <div style={{marginLeft:"50px", marginRight:"50px",width: '248px', height: '124px', borderRadius: '16px', border: '1px solid black', display: 'flex', flexDirection: 'column', alignItems: 'center' }}   onClick={handleOperatorBoxClick}>
        <img src={TTelecom} alt="Tunisie Telecom" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} />
       
    </div>
    <div style={{ width: '248px', height: '124px', borderRadius: '16px', border: '1px solid black', display: 'flex', flexDirection: 'column', alignItems: 'center' }}  onClick={handleOperatorBoxClick}>
        <img src={Oredo} alt="Ooredoo" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} />
        
    </div>
    <div style={{ width: '248px', height: '124px', borderRadius: '16px', border: '1px solid black', display: 'flex', flexDirection: 'column', alignItems: 'center' }}  onClick={handleOperatorBoxClick}>
        <img src={Orang} alt="Orange" style={{ width: '80%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} />
        
    </div>
    <div style={{marginRight:"50px", width: '248px', height: '124px', borderRadius: '16px', border: '1px solid black', display: 'flex', flexDirection: 'column', alignItems: 'center' }} onClick={handleOperatorBoxClick}>
        <img src={Lycamobil} alt="Lycamobile" style={{ width: '240px', height: '120px', objectFit: 'cover', borderRadius: '16px' }} />
       
    </div>
   
</div>
<div style={{marginLeft:"10px", marginTop: '50px', whiteSpace: 'nowrap', fontFamily: 'Revert', fontSize: '22px', fontWeight: 1700, lineHeight: '19px', letterSpacing: 0, textAlign: 'left', width: '200px', height: '49px' }}>
        2. Select a recharge amount
    </div>
    <div style={{ display: 'flex', marginTop: '30px' }}>
        <div style={{marginLeft:"20px",width: '89px', height: '89px', borderRadius: '16px', border: '1px solid black', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: 'Revert', fontSize: '34px', fontWeight: 600, lineHeight: '46px', letterSpacing: '0em', textAlign: 'right', color: 'linear-gradient(90deg, #00BDA9 0%, #00C0FC 100%)' }}    onClick={handleAmountBoxClick}>
        <img src={Twodt} alt="2dt" style={{ width: '100%', height: '100%', objectFit: 'cover', borderRadius: '16px' }} />

            </div>
        <div style={{  width: '89px', height: '89px', borderRadius: '16px', border: '1px solid black', marginLeft: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: 'Revert', fontSize: '34px', fontWeight: 600, lineHeight: '46px', letterSpacing: '0em', textAlign: 'right', color: 'linear-gradient(90deg, #00BDA9 0%, #00C0FC 100%)'}} onClick={handleAmountBoxClick}>
        <img src={Fivedt} alt="5dt" style={{ width: '100%', height: '80%', objectFit: 'cover', borderRadius: '16px' }} />

            
            
        </div>
        <div style={{ width: '89px', height: '89px', borderRadius: '16px', border: '1px solid black', marginLeft: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: 'Revert', fontSize: '34px', fontWeight: 600, lineHeight: '46px', letterSpacing: '0em', textAlign: 'right' }} onClick={handleAmountBoxClick}>
        <img src={Tendt} alt="10dt" style={{ width: '100%', height: '90%', objectFit: 'cover', borderRadius: '16px' }} />
        </div>
        <div style={{  width: '89px', height: '89px', borderRadius: '16px', border: '1px solid black', marginLeft: '20px', display: 'flex', justifyContent: 'center', alignItems: 'center', fontFamily: 'Revert', fontSize: '34px', fontWeight: 600, lineHeight: '46px', letterSpacing: '0em', textAlign: 'right'  }} onClick={handleAmountBoxClick}>
        <img src={Twentydt} alt="20dt" style={{ width: '100%', height: '90%', objectFit: 'cover', borderRadius: '16px' }} />
        </div>
