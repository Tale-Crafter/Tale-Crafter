    ...
    <div className="container" style={{ borderRadius:10,display: "flex", justifyContent: "center", alignItems: "center", height: "80vh", position: 'absolute', left: 340,top:84, background:"white",width:'76%' }}>
      <main className="main">
        ...
        <section className="content" style={{ textAlign: "center" ,position:"absolute",top:320,left:370}}>
          <SquareButton title="Customize distribution channels" description="Tailor your survey distribution: send via email, embed on your website, share links on social media or web pages, and more." imageUrl={process.env.PUBLIC_URL + '/i1.png'} to="/createsurvey" />
